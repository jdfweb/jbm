...
<header class="contain-to-grid sticky">
	...
	<nav class="top-bar" data-topbar>
	    <ul class="title-area">
	        <li class="name">
	        	<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img style="margin-left:10px;" src="<?php echo get_template_directory_uri(); ?>/img/jewellery-by-moriah-logo.png" /></a>
	        </li>
